            ...
            <div className="card">
                <div className="card-body">
                    <div className="alert alert-light" role="alert">
                        <p className="mb-2">
                            <strong>Hey!</strong> This is only a part of all Bootstrap Utilites.
                            Follow next links to get information about all of them:
                        </p>
                        <a
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href=""
                                                    target="_blank"
                                                    className="kit__utils__link__underlined"
                                                >
                                                    Underlined Link
                                                </a>
                                            </td>
                                ...
                                <table className="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                Truncating and prevents text from wrapping into
                                                multiple lines
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                Breaks strings if their length exceeds the width of
                                                their container
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div className="p-3">
                                    <div className="row">
                                        <div className="col-md-4">
                                            ...
                                            >
                                                This is text truncate. This is text truncate. This
                                                is text truncate. This is text truncate
                                            </div>
                                        </div>
                                        <div className="col-md-4">
                                            <div
                                        ...
                                        <div className="col-md-4">
                                            ...
                                            >
                                                This is text nowrap. This is text nowrap. This is
                                                text nowrap. This is text nowrap
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table className="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                Available values: 0, 10, 12, 14, 16, 18, 21, 24, 28,
                                                30, 36, 40, 48, 50, 60, 70 , 80
                                            </td>
                                        </tr>
                                        <tr>
                                            <td className="text-nowrap">
                            ...
                            <div className="mb-5">
                                ...
                                <div className="p-3">
                                    ...
                                    <p className="text-justify">
                                        Justified text: Lorem Ipsum is simply dummy text of the
                                    ...
                                    <table className="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    Forces the element to behave like an inline
                                                    element
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    Forces the element to behave like an
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    Forces the element to behave like a block
                                                    element
                                                </td>
                                            </tr>
                                        </tbody>
