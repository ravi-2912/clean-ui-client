            ...
            <div className="row">
                <div className="col-lg-12">
                    ...
                    <div className="mb-5">
                        ...
                        >
                            <div
                                style={{ maxWidth: '700px', margin: '0px auto', fontSize: '14px' }}
                            >
                                <table
                                    cellPadding="0"
                                    cellSpacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <p>Hi there,</p>
                                                    <p>
                                                        Sometimes you just want to send a simple
                                                        HTML email with a simple design and clear
                                                        call to action.
                                                    </p>
                                                    <a
                                                        style={{
                                                    ...
                                                    <p>
                                                        ...
                                                        It&apos;s sole purpose is to get the
                                                        recipient to click the button with no
                                                        distractions.
                                                    </p>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>
                                                        ...
                                                        Clean UI KIT Pro. If this is true, click
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Hi George,</p>
                                                    <p>
                                                        Congratulations! Something good has appened.
                                                    </p>
                                                    <div style={{ textAlign: 'center' }}>
                                                        <a
                                                            style={{
                                                    ...
                                                    <p>
                                                        Thanks for being great customer. Let it be!
                                                    </p>
                                                </td>
                                            </tr>
                                        </tbody>
