                        ...
                        <div className="col-lg-4">
                            <div className="mb-5">
                                ...
                                <p>
                                    ...
                                    half their computed line-height (1rem by default)
                                </p>
                            </div>
                        </div>
                        <div className="col-lg-4">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-8">
                            <div className="mb-5">
                                ...
                                <p className="text-muted">
                                    Use the well as a simple effect on an element to give it an
                                    inset effect
                                </p>
                                <dl className="row">
                            ...
                            <div className="row">
                                <div className="col-lg-10 mb-2">
                                    <blockquote className="blockquote">
                                        <p className="mb-0">
                                            Led cursus ante dapibus diam. Sed nisi. Nulla quis sem
                                            at nibh elementum imperdiet. Duis sagittis ipsum.
                                            Praesent mauris. at nibh elementum imperdiet. Duis
                                            ...
                                            lacinia nunc.sed cursus ante dapibus diam. Sed nisi.
