                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <h5 className="text-black">
                                <strong>
                                    A package of flat vector icons together with an installable
                                    ligature font
                                </strong>
                            </h5>
                            <p className="text-muted">
                                ...
                                <br />
                                License: MIT License. You can use it for commercial projects, open
                                source projects, or really just about whatever you want
                            </p>
                        </div>
                    </div>
                    <div className="row">
