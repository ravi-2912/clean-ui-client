                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="mb-2">
                                ...
                                >
                                    [Feature Request] How to enable custom font that comes from svg
                                    #2460
                                </a>
                            </div>
                            <div className="mb-3">
                            ...
                            <div>
                                <p>
                                    ...
                                    laborum est perferendis consectetur corporis esse labore minima
                                    molestias, exercitationem consequuntur! Lorem ipsum dolor sit
                                    amet, consectetur adipisicing elit. Nihil laborum est
                                    perferendis consectetur corporis esse labore minima molestias,
                                    exercitationem consequuntur! Lorem ipsum dolor sit amet,
                                    consectetur adipisicing elit. Nihil laborum est perferendis
                                    consectetur corporis esse labore minima molestias,
                                    exercitationem consequuntur! Lorem ipsum dolor sit amet,
                                    consectetur adipisicing elit. Nihil laborum est perferendis
                                    consectetur corporis esse labore minima molestias,
                        ...
                        <div className="card-body">
                            <div className="mb-2">
                                <a
                                    ...
                                    className="text-dark font-size-24 font-weight-bold"
                                >
                                    London&apos;s mayor compared President Trump to an 11-year-old
                                    child
                                </a>
                            </div>
                            <div className="mb-3">
