            ...
            <div className="d-flex flex-wrap">
                <div className="mr-auto pr-3 my-2">
                    ...
                    <div className="text-nowrap d-inline-block font-size-18 text-dark">
                        <a
                            className="font-size-18 text-blue"
                            href="#"
                    ...
                    <div className="d-flex align-items-start mb-3">
                        ...
                        <div className="card flex-grow-1">
                            ...
                            <div className="card-body">
                                <h3>Description</h3>
                                <p>
                                    Added child elements to the active text editor lose their
                                    scrollTop property when they are scrolled out of view.
                                </p>
                                <p>
                                    Hydrogen a popular atom package adds a React Component inline to
                                    the text editor to view results from external code execution
                                    through jupyter kernels.
                                </p>
                                <p>
                                    This React Component contains a standard div element (not an
                                    immediate child but down the sub tree) that if their is enough
                                    output can scroll.
                                </p>
                                <p>
                                    If you scroll inside of the element and then scroll down the
                                    text editor for it to fall out of view and be temporarily
                                    removed from the DOM. If you scroll back up that scroll position
                                    inside the element is lost.
                                </p>
                                <h3>Steps to Reproduce</h3>
                                <ol>
                                    <li>Have hydrogen active and setup properly</li>
                                    <li>
                                        Use <code>Run Cell</code> command from hydrogen on the code
                                        below with about 50 extra new lines
                                    </li>
                                </ol>
                                <pre>
                                ...
                                <p>
                                    <strong>Actual behavior:</strong> Scroll top of the result view
                                    has been set to 0 upon removal and adding back to the active DOM
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    <code>atom --version</code> and <code>apm --version</code> from
                                    the command line. Also, please include the OS and what version
                                ...
                                <p>
                                    This isn&apos;t platform specific either, and I don&apos;t
                                    believe its a hydrogen problem.
                                    <br />I believe this is a problem with how etch processes the
                                    render of React Components or how it stores html nodes when
                                    removing them. But I understand its more complex than that.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-3">
                    ...
                    <div className="py-4 border-bottom">
                        ...
                        <a
                            href="#"
                            onClick={e => e.preventDefault()}
                            className="btn btn-light text-blue mb-2"
                        >
                            Subscribe
                        </a>
