        ...
        <div>
            ...
            <div className="d-flex flex-wrap align-items-center">
                ...
                <div className="mr-auto mb-3">
                    ...
                    <div>
                        Operational / Developer tooling / Update your project information under
                        Settings
                    </div>
                </div>
                <a
            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    <div className="card">
                        <div className="card-body pt-3 pb-3">
                            <div className="text-uppercase text-dark font-weight-bold">
                                Performance
                            </div>
                            <div className="text-center text-blue">
            ...
            <p className="mb-4">
                Automatic system-level backups. Use the backup images to revert the server or create
                new Droplets. Backups cost 20% of the Droplet price.
            </p>
            <a
            ...
            <p className="mb-4">
                Block storage lets you add independent storage volumes that can be accessed like
                local disk and moved from one Droplet to another within the same region.
            </p>
            <a
            ...
            <div className="row">
                <div className="col-md-5">
                    <Input
                        className="width-100p mb-5"
                        placeholder="Please choose droplet hostname..."
                    />
                </div>
            </div>
            <a
