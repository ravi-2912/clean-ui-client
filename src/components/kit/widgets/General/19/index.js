        ...
        <div>
            ...
            <div className="d-flex flex-column flex-sm-row">
                ...
                <p className="pt-3 mb-0">
                    ...
                    blanditiis debitis deleniti distinctio ducimus et ex incidunt maxime minima
                    minus nemo nisi quos repellendus, temporibus ullam veniam voluptas voluptate.w
                </p>
            </div>
        </div>
    )
